...
digits=2
options(scipen = 999)
script.version="©SP/NC 2018-06-09, v1.0.3"
...
clean <- rm("/tmp/polished_assembly.tex")
...
clean <- rm("/tmp/mapping_stats_hgap.tex")
...
clean <- rm("/tmp/coverage_report_hgap.tex")
